...
$( document ).ready(function() {  
    ...
    $("#selectedDate").text($(".fc-today").text());

    function dateSelected(){
        $( ".callendarDates" ).removeClass('accent-background');
        $( ".callendarDates" ).removeClass('fc-today');
        $(this).addClass('accent-background');
    ...
    $(".callendarDates").bind("click", function () {
        ...
        $.ajax({
            url: "/Dentist/dentistAppointmentsList",
            method: "post",
            async: false,
    ...
    $(".aviableBtn").click(function(){
        ...
        $("i",this).addClass("icon-line-play");
        $(this).closest("td").prev().text("");
        $("span",this).text("Aviable");                
        ...
        _getBody : function() {
            ...
            for ( var i = 0; i < 7; i++ ) {
                ...
                for ( var j = 0; j <= 6; j++ ) {
                    ...
                    cellClasses+='callendarDates ';

                    html += cellClasses !== '' ? '<button class="' + cellClasses + '">' : '<button>';
                    html += inner;
                    html += '</button>';
